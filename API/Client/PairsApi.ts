...
namespace API.Client {
    ...
    export class PairsApi {
         ...
         */
        public v1PairsCsvGet (cause: string, effect: string, accessToken?: string, causeSource?: string, causeUnit?: string, delay?: string, duration?: string, effectSource?: string, effectUnit?: string, endTime?: string, startTime?: string, limit?: number, offset?: number, sort?: number, extraHttpRequestParams?: any ) : ng.IHttpPromise<Array<Pairs>> {
            ...
            if (!cause) {
                throw new Error('Missing required parameter cause when calling v1PairsCsvGet');
            }
            // verify required parameter 'effect' is set
            if (!effect) {
                throw new Error('Missing required parameter effect when calling v1PairsCsvGet');
            }
         ...
         * @param sort Sort by given field. If the field is prefixed with &#x60;-, it will sort in descending order.
         */
        public v1PairsGet (cause: string, effect: string, accessToken?: string, causeSource?: string, causeUnit?: string, delay?: string, duration?: string, effectSource?: string, effectUnit?: string, endTime?: string, startTime?: string, limit?: number, offset?: number, sort?: number, extraHttpRequestParams?: any ) : ng.IHttpPromise<Array<Pairs>> {
            ...
            // verify required parameter 'cause' is set
            if (!cause) {
                throw new Error('Missing required parameter cause when calling v1PairsGet');
            }
            // verify required parameter 'effect' is set
            if (!effect) {
                throw new Error('Missing required parameter effect when calling v1PairsGet');
            }
            if (accessToken !== undefined) {
                queryParameters['access_token'] = accessToken;
            }
