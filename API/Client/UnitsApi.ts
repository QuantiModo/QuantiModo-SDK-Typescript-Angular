...
namespace API.Client {
    ...
    export class UnitsApi {
         ...
         */
        public v1UnitsGet (accessToken?: string, id?: number, unitName?: string, abbreviatedUnitName?: string, categoryName?: string, extraHttpRequestParams?: any ) : ng.IHttpPromise<Array<Unit>> {
         ...
         */
        public v1UnitsVariableGet (accessToken?: string, unitName?: string, abbreviatedUnitName?: string, categoryName?: string, variable?: string, extraHttpRequestParams?: any ) : ng.IHttpPromise<Array<Unit>> {
