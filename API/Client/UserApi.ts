...
namespace API.Client {
    ...
    export class UserApi {
         ...
         */
        public v1OrganizationsOrganizationIdUsersPost (organizationId: number, body: UserTokenRequest, accessToken?: string, extraHttpRequestParams?: any ) : ng.IHttpPromise<UserTokenSuccessfulResponse> {
         ...
         */
        public v1UserMeGet (extraHttpRequestParams?: any ) : ng.IHttpPromise<User> {
