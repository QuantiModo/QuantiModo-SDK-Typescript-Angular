...
(function (API) {
    ...
    (function (Client) {
        ...
        var AuthenticationApi = (function () {
            ...
            AuthenticationApi.prototype.extendObj = function (objA, objB) {
                for (var key in objB) {
             ...
             */
            AuthenticationApi.prototype.v2AuthSocialAuthorizeCodeGet = function (code, provider, extraHttpRequestParams) {
                var localVarPath = this.basePath + '/v2/auth/social/authorizeCode';
                var queryParameters = {};
             ...
             */
            AuthenticationApi.prototype.v2AuthSocialAuthorizeTokenGet = function (accessToken, provider, refreshToken, extraHttpRequestParams) {
                var localVarPath = this.basePath + '/v2/auth/social/authorizeToken';
                var queryParameters = {};
                var headerParams = this.extendObj({}, this.defaultHeaders);
             ...
             * @param provider The current options are &#x60;google&#x60; and &#x60;facebook&#x60;.
             */
            AuthenticationApi.prototype.v2AuthSocialLoginGet = function (redirectUrl, provider, extraHttpRequestParams) {
                var localVarPath = this.basePath + '/v2/auth/social/login';
                var queryParameters = {};
                var headerParams = this.extendObj({}, this.defaultHeaders);
             ...
             */
            AuthenticationApi.prototype.v2Oauth2AccessTokenGet = function (clientId, clientSecret, grantType, code, responseType, scope, redirectUri, state, extraHttpRequestParams) {
                var localVarPath = this.basePath + '/v2/oauth2/access_token';
                var queryParameters = {};
                var headerParams = this.extendObj({}, this.defaultHeaders);
             ...
             * @param state An opaque string that is round-tripped in the protocol; that is to say, it is returned as a URI parameter in the Basic flow, and in the URI
             */
            AuthenticationApi.prototype.v2OauthAuthorizeGet = function (clientId, clientSecret, responseType, scope, redirectUri, state, extraHttpRequestParams) {
                var localVarPath = this.basePath + '/v2/oauth/authorize';
                var queryParameters = {};
                var headerParams = this.extendObj({}, this.defaultHeaders);
                // verify required parameter 'clientId' is not null or undefined
                if (clientId === null || clientId === undefined) {
        ...
        Client.AuthenticationApi = AuthenticationApi;
