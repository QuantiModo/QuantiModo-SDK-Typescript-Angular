...
namespace API.Client {
    ...
    export class CorrelationsApi {
         ...
         */
        public v1OrganizationsOrganizationIdUsersUserIdVariablesVariableNameCausesGet (organizationId: number, userId2: number, variableName: string, organizationToken: string, userId?: number, includePublic?: string, extraHttpRequestParams?: any ) : ng.IHttpPromise<Array<Correlation>> {
         ...
         * @param includePublic Include public correlations, Can be \&quot;1\&quot; or empty.
         */
        public v1OrganizationsOrganizationIdUsersUserIdVariablesVariableNameEffectsGet (organizationId: number, userId2: number, variableName: string, organizationToken: string, userId?: number, includePublic?: string, extraHttpRequestParams?: any ) : ng.IHttpPromise<Array<CommonResponse>> {
         ...
         * @param outcomesOfInterest Only include correlations for which the effect is an outcome of interest for the user
         */
        public v1PublicCorrelationsSearchSearchGet (search: string, effectOrCause: string, userId?: number, outcomesOfInterest?: boolean, extraHttpRequestParams?: any ) : ng.IHttpPromise<Array<Correlation>> {
         ...
         */
        public v1VariablesVariableNameEffectsGet (variableName: string, userId?: number, correlationCoefficient?: string, extraHttpRequestParams?: any ) : ng.IHttpPromise<Array<Correlation>> {
         ...
         */
        public v1VariablesVariableNamePublicCausesGet (variableName: string, userId?: number, correlationCoefficient?: string, extraHttpRequestParams?: any ) : ng.IHttpPromise<Array<Correlation>> {
         ...
         * @param userId User&#39;s id
         */
        public v1VariablesVariableNamePublicEffectsGet (variableName: string, userId?: number, extraHttpRequestParams?: any ) : ng.IHttpPromise<Array<Correlation>> {
