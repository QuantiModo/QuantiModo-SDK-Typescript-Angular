...
(function (API) {
    ...
    (function (Client) {
        ...
        var MeasurementsApi = (function () {
            ...
            MeasurementsApi.prototype.extendObj = function (objA, objB) {
                for (var key in objB) {
             ...
             */
            MeasurementsApi.prototype.v1MeasurementSourcesGet = function (extraHttpRequestParams) {
                var localVarPath = this.basePath + '/v1/measurementSources';
                var queryParameters = {};
             ...
             */
            MeasurementsApi.prototype.v1MeasurementSourcesPost = function (body, userId, extraHttpRequestParams) {
                var localVarPath = this.basePath + '/v1/measurementSources';
                var queryParameters = {};
                var headerParams = this.extendObj({}, this.defaultHeaders);
             ...
             */
            MeasurementsApi.prototype.v1MeasurementsDailyGet = function (variableName, userId, unitAbbreviatedName, startTime, endTime, groupingWidth, groupingTimezone, limit, offset, sort, extraHttpRequestParams) {
                var localVarPath = this.basePath + '/v1/measurements/daily';
                var queryParameters = {};
                var headerParams = this.extendObj({}, this.defaultHeaders);
             ...
             */
            MeasurementsApi.prototype.v1MeasurementsDeletePost = function (body, extraHttpRequestParams) {
                var localVarPath = this.basePath + '/v1/measurements/delete';
                var queryParameters = {};
                var headerParams = this.extendObj({}, this.defaultHeaders);
                // verify required parameter 'body' is not null or undefined
                if (body === null || body === undefined) {
             ...
             * @param sort Sort by given field. If the field is prefixed with &#x60;-, it will sort in descending order.
             */
            MeasurementsApi.prototype.v1MeasurementsGet = function (userId, id, variableName, variableCategoryName, sourceName, value, unitAbbreviatedName, earliestMeasurementTime, latestMeasurementTime, createdAt, updatedAt, groupingWidth, groupingTimezone, limit, offset, sort, extraHttpRequestParams) {
                var localVarPath = this.basePath + '/v1/measurements';
                var queryParameters = {};
                var headerParams = this.extendObj({}, this.defaultHeaders);
                if (userId !== undefined) {
                    queryParameters['userId'] = userId;
             ...
             * @param userId User&#39;s id
             */
            MeasurementsApi.prototype.v1MeasurementsPost = function (body, userId, extraHttpRequestParams) {
                var localVarPath = this.basePath + '/v1/measurements';
                var queryParameters = {};
                var headerParams = this.extendObj({}, this.defaultHeaders);
                // verify required parameter 'body' is not null or undefined
             ...
             */
            MeasurementsApi.prototype.v1MeasurementsRangeGet = function (sources, user, extraHttpRequestParams) {
                var localVarPath = this.basePath + '/v1/measurementsRange';
                var queryParameters = {};
                var headerParams = this.extendObj({}, this.defaultHeaders);
             ...
             */
            MeasurementsApi.prototype.v1MeasurementsUpdatePost = function (body, extraHttpRequestParams) {
                var localVarPath = this.basePath + '/v1/measurements/update';
                var queryParameters = {};
                var headerParams = this.extendObj({}, this.defaultHeaders);
                // verify required parameter 'body' is not null or undefined
                if (body === null || body === undefined) {
             ...
             * @param userId User&#39;s id
             */
            MeasurementsApi.prototype.v2MeasurementsCsvGet = function (accessToken, userId, extraHttpRequestParams) {
                var localVarPath = this.basePath + '/v2/measurements/csv';
                var queryParameters = {};
                var headerParams = this.extendObj({}, this.defaultHeaders);
             ...
             * @param userId User&#39;s id
             */
            MeasurementsApi.prototype.v2MeasurementsRequestCsvPost = function (accessToken, userId, extraHttpRequestParams) {
                var localVarPath = this.basePath + '/v2/measurements/request_csv';
                var queryParameters = {};
                var headerParams = this.extendObj({}, this.defaultHeaders);
                if (accessToken !== undefined) {
                    queryParameters['access_token'] = accessToken;
             ...
             * @param userId User&#39;s id
             */
            MeasurementsApi.prototype.v2MeasurementsRequestPdfPost = function (accessToken, userId, extraHttpRequestParams) {
                var localVarPath = this.basePath + '/v2/measurements/request_pdf';
                var queryParameters = {};
                var headerParams = this.extendObj({}, this.defaultHeaders);
                if (accessToken !== undefined) {
                    queryParameters['access_token'] = accessToken;
             ...
             * @param userId User&#39;s id
             */
            MeasurementsApi.prototype.v2MeasurementsRequestXlsPost = function (accessToken, userId, extraHttpRequestParams) {
                var localVarPath = this.basePath + '/v2/measurements/request_xls';
                var queryParameters = {};
                var headerParams = this.extendObj({}, this.defaultHeaders);
                if (accessToken !== undefined) {
                    queryParameters['access_token'] = accessToken;
        ...
        Client.MeasurementsApi = MeasurementsApi;
