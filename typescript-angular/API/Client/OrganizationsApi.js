...
(function (API) {
    ...
    (function (Client) {
        ...
        var OrganizationsApi = (function () {
            function OrganizationsApi($http, $httpParamSerializer, basePath) {
                this.$http = $http;
            ...
            OrganizationsApi.prototype.extendObj = function (objA, objB) {
                for (var key in objB) {
             ...
             */
            OrganizationsApi.prototype.v1OrganizationsOrganizationIdUsersPost = function (organizationId, body, userId, extraHttpRequestParams) {
        ...
        OrganizationsApi.$inject = ['$http', '$httpParamSerializer', 'basePath'];
        Client.OrganizationsApi = OrganizationsApi;
