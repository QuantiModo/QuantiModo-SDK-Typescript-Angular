...
(function (API) {
    ...
    (function (Client) {
        'use strict';
        var PairsApi = (function () {
            function PairsApi($http, $httpParamSerializer, basePath) {
                this.$http = $http;
            ...
            PairsApi.prototype.extendObj = function (objA, objB) {
                for (var key in objB) {
             ...
             */
            PairsApi.prototype.v1PairsCsvGet = function (cause, effect, userId, causeSource, causeUnit, delay, duration, effectSource, effectUnit, endTime, startTime, limit, offset, sort, extraHttpRequestParams) {
                var localVarPath = this.basePath + '/v1/pairsCsv';
                var queryParameters = {};
             ...
             * @param sort Sort by given field. If the field is prefixed with &#x60;-, it will sort in descending order.
             */
            PairsApi.prototype.v1PairsGet = function (cause, effect, userId, causeSource, causeUnit, delay, duration, effectSource, effectUnit, endTime, startTime, limit, offset, sort, extraHttpRequestParams) {
                var localVarPath = this.basePath + '/v1/pairs';
                var queryParameters = {};
                var headerParams = this.extendObj({}, this.defaultHeaders);
                // verify required parameter 'cause' is not null or undefined
                if (cause === null || cause === undefined) {
        ...
        PairsApi.$inject = ['$http', '$httpParamSerializer', 'basePath'];
        Client.PairsApi = PairsApi;
