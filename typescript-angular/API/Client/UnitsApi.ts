...
namespace API.Client {
    ...
    export class UnitsApi {
         ...
         */
        public v1UnitsGet (userId?: number, id?: number, unitName?: string, unitAbbreviatedName?: string, unitCategoryName?: string, extraHttpRequestParams?: any ) : ng.IHttpPromise<Array<Unit>> {
         ...
         */
        public v1UnitsVariableGet (userId?: number, unitName?: string, unitAbbreviatedName?: string, unitCategoryName?: string, variable?: string, extraHttpRequestParams?: any ) : ng.IHttpPromise<Array<Unit>> {
