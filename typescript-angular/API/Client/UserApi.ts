...
namespace API.Client {
    ...
    export class UserApi {
         ...
         */
        public v1OrganizationsOrganizationIdUsersPost (organizationId: number, body: UserTokenRequest, accessToken?: string, userId?: number, extraHttpRequestParams?: any ) : ng.IHttpPromise<UserTokenSuccessfulResponse> {
