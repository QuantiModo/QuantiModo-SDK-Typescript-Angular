...
namespace API.Client {
    ...
    export class VariablesApi {
         ...
         */
        public v1PublicVariablesGet (accessToken?: string, userId?: number, id?: number, category?: string, name?: string, updatedAt?: string, source?: string, latestMeasurementTime?: string, numberOfRawMeasurements?: string, lastSource?: string, limit?: number, offset?: number, sort?: number, extraHttpRequestParams?: any ) : ng.IHttpPromise<Variable> {
         ...
         * @param sort Sort by given field. If the field is prefixed with &#x60;-, it will sort in descending order.
         */
        public v1PublicVariablesSearchSearchGet (search: string, accessToken?: string, userId?: number, variableCategoryName?: string, source?: string, effectOrCause?: string, publicEffectOrCause?: string, limit?: number, offset?: number, sort?: number, extraHttpRequestParams?: any ) : ng.IHttpPromise<Variable> {
         ...
         * @param sort Sort by given field. If the field is prefixed with &#x60;-, it will sort in descending order.
         */
        public v1VariablesGet (accessToken?: string, userId?: number, id?: number, category?: string, name?: string, updatedAt?: string, source?: string, latestMeasurementTime?: string, numberOfRawMeasurements?: string, lastSource?: string, limit?: number, offset?: number, sort?: number, extraHttpRequestParams?: any ) : ng.IHttpPromise<Variable> {
         ...
         * @param userId User&#39;s id
         */
        public v1VariablesPost (body: VariablesNew, accessToken?: string, userId?: number, extraHttpRequestParams?: any ) : ng.IHttpPromise<{}> {
            const localVarPath = this.basePath + '/v1/variables';
         ...
         * @param offset Since the maximum limit is 200 records, to get more than that you&#39;ll have to make multiple API calls and page through the results. To retrieve all the data, you can iterate through data by using the &#x60;limit&#x60; and &#x60;offset&#x60; query parameters.  For example, if you want to retrieve data from 61-80 then you can use a query with the following parameters, &#x60;imit&#x3D;20&amp;offset&#x3D;60&#x60;.
         */
        public v1VariablesSearchSearchGet (search: string, accessToken?: string, userId?: number, variableCategoryName?: string, includePublic?: boolean, manualTracking?: boolean, source?: string, effectOrCause?: string, publicEffectOrCause?: string, limit?: number, offset?: number, extraHttpRequestParams?: any ) : ng.IHttpPromise<Array<Variable>> {
         ...
         * @param userId User&#39;s id
         */
        public v1VariablesVariableNameGet (variableName: string, accessToken?: string, userId?: number, extraHttpRequestParams?: any ) : ng.IHttpPromise<Variable> {
